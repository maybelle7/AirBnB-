...
# listings with a price above 17,251.78 YEN per night
dataframe = dataframe[dataframe["Price"] <= 17,251.78]

# Display as integer
dataframe["Airbnb Listing ID"] = dataframe["Airbnb Listing ID"].astype(int)
# Round of values
dataframe["Price"] = dataframe["Price"].round(2).astype(str) + "YEN" # <--- CHANGE THIS POUND SYMBOL IF YOU CHOSE CURRENCY OTHER THAN POUND
